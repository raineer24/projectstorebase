...
export class ProductService {
   ...
   * @memberof ProductService
   */
  getItemsBySearch(keyword: string, offset = 0, limit = 5): Observable<any> {
    return this.http.get(`v1/item?offset=${offset}&limit=${limit}&keyword=${keyword}`)
    // `v1/item?offset=0&limit=10&${}category3=${categoryId}`
    .map(res => res.json())
   ...
   * @memberof ProductService
   */
  getItemByCategory(id: string, categoryId: number): Observable<any> {
